<?php
$base_url = "http://correspondent.xyz/";
$itemprop_name = $title;
...
<html lang="ja">
  <head>
	...
	<meta property="og:url" content="http://faceapglezon.info/ogimage/icalendar.php?url=<?php echo (empty($_SERVER["HTTPS"]) ? "http://" : "https://") . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"];?>" />
